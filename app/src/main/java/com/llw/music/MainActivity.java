...
//                    mAdapter.notifyItemRangeChanged(0, mList.size());
    ...
    @OnClick({R.id.tv_clear_list, R.id.btn_scan, R.id.btn_previous, R.id.btn_play_or_pause, R.id.btn_next, R.id.delete_play})
